	...
	<main class="main-wrapper">
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="top-bar__item">
							...
							<a href="tel:1-800-995-3959" class="top-bar__phone-number">1300 55 36 44</a>
						</div>
						<div class="top-bar__item">
							<i class="top-bar__icon ui-email"></i>
							<a href="mailto:hi@sedona.com" class="top-bar__email">info@xclusivehomes.com.au</a>
						</div>
					</div>
					<div class="col-lg-6">
						...
						<div class="flex-parent">
							...
							<nav id="navbar-collapse" class="nav__wrap collapse navbar-collapse">
								...
								<div class="nav__phone nav__phone--mobile d-lg-none">
									...
									<a href="tel:1-800-995-3959" class="nav__phone-number">1300 55 36 44</a>
								</div>							

								<!-- Mobile Email -->
								<div class="nav__email nav__email--mobile d-lg-none">
									<span class="nav__email-text">Email us:</span>
									<a href="mailto:hi@sedona.com" class="nav__email-email">info@xclusivehomes.com.au</a>
								</div>

								<!-- Mobile Socials -->
								<div hidden class="nav__socials nav__socials--mobile d-lg-none">
									<div class="socials">
										<a href="#" class="social social-twitter" aria-label="twitter" title="twitter" target="_blank"><i class="ui-twitter"></i></a>
										<a href="#" class="social social-facebook" aria-label="facebook" title="facebook" target="_blank"><i class="ui-facebook"></i></a>
										<a href="#" class="social social-youtube" aria-label="youtube" title="google plus" target="_blank"><i class="ui-youtube"></i></a>
		...
		<div class="content-wrapper oh">
			...
			<div class="rev_slider_wrapper">
				<div class="rev_slider" id="slider-2" data-version="5.0">
					<ul>
						<!-- SLIDE 1 -->
						<li data-fstransition="fade"
							...
							>
							<!-- MAIN IMAGE -->
							<img src="img/revolution/home-2/1.jpg"
								alt=""
							...
							<div class="tp-caption hero-text"
								...
								data-splitout="none">XClusive Home Builders<span class="hero-dot">.</span>
							</div>
							...
							<div class="tp-caption"
									...
									<a href="projects.html" class='btn btn--lg btn--color'>View Project</a>
							</div>
			...
			<section class="section-wrap pt-0 pb-0 pt-sm-40 offset-top-100">
				<div class="container">
					<div class="row">
						<div class="col-md-4">
							<div class="benefit">
								<i class="icon-House-9 benefit__icon"></i>
								<h4 class="benefit__title">Design With Purpose</h4>
								<p class="benefit__text">For each project we establish relationships with partners who we know will help us create added value for your project.</p>
							</div>
						</div>
						<div class="col-md-4">
							<div class="benefit">
								<i class="icon-Brick-Gouse benefit__icon"></i>
								<h4 class="benefit__title">High Quality Materials</h4>
								<p class="benefit__text">For each project we establish relationships with partners who we know will help us create added value for your project.</p>
							</div>
						</div>
						<div class="col-md-4">
							<div class="benefit">
								<i class="icon-Cup-1 benefit__icon"></i>
								<h4 class="benefit__title">25 Years of Experience</h4>
								<p class="benefit__text">For each project we establish relationships with partners who we know will help us create added value for your project.</p>
							</div>
						</div>
					</div>
			...
			<!-- Services -->
			<div hidden class="services">
				<div class="row no-gutters">
					<div class="col-lg-3">
						<a href="#" class="service service--dark-overlay">
							<div class="service__img" style="background-image: url(img/services/1.jpg);"></div>
							<h3 class="service__title">Interior Design</h3>
						</a>
					</div>
					<div class="col-lg-3">
						<a href="#" class="service service--dark-overlay">
							<div class="service__img" style="background-image: url(img/services/2.jpg);"></div>
							<h3 class="service__title">Exterior Design</h3>
						</a>
					</div>
					<div class="col-lg-3">
						<a href="#" class="service service--dark-overlay">
							<div class="service__img" style="background-image: url(img/services/3.jpg);"></div>
							<h3 class="service__title">Office Design</h3>
						</a>
					</div>
					<div class="col-lg-3">
						<a href="#" class="service service--dark-overlay">
							<div class="service__img" style="background-image: url(img/services/4.jpg);"></div>
							<h3 class="service__title">Industrial Premises</h3>
						</a>
					</div>
				</div>
			</div> <!-- end services -->
			...
			<!-- Team -->
 			<section class="section-wrap pt-72 pb-72 pb-lg-40">
				<div class="container">
					...
					<!-- Filter -->
					<div hidden class="masonry-filter">
